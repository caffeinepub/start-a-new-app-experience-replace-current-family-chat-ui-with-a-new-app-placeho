...
export class Backend implements backendInterface {
    ...
    async addMember(arg0: FamilyMember): Promise<void> {
        if (this.processError) {
            try {
    ...
    async fetchMessages(arg0: bigint, arg1: bigint): Promise<Array<ChatMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchMessages(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listMembers(): Promise<Array<FamilyMember>> {
        if (this.processError) {
            try {
    ...
    async postMessage(arg0: string): Promise<MessageId> {
        if (this.processError) {
            try {
    ...
    async removeMember(arg0: FamilyMember): Promise<void> {
        if (this.processError) {
            try {
